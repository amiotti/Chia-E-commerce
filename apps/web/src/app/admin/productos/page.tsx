      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <header className="panel-surface mb-5 rounded-3xl border border-[#587055]/15 p-5 sm:p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div><p className="text-xs uppercase tracking-[0.3em] text-[#587055]">Panel de productos</p><h1 className="mt-1 text-4xl font-semibold leading-tight tracking-tight text-[#0B3816] sm:text-5xl">Gestión de productos</h1><p className="mt-2 text-sm text-[#0B3816]/75 sm:text-base">Cargá, importá y administrá el catálogo de CHÍA Espacio Saludable desde un solo lugar.</p><p className="mt-2 text-xs uppercase tracking-[0.2em] text-[#587055]">Sesión: {session.email} ({session.role})</p></div>
