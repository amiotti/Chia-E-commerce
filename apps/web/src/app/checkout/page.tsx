        ...
        <header className="panel-surface mb-5 rounded-3xl border border-[#587055]/15 p-5 sm:p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-[#0B3816]/75">Creación de orden en estado pendiente de pago (sin gateway aún).</p>
            </div>
            <Link href="/carrito" className="rounded-full border border-[#8BA37D]/40 bg-white/70 px-4 py-2 text-sm text-[#0B3816] hover:bg-[#F0ECDF]">
              Volver al carrito
            </Link>
          </div>
        </header>
