...
import { getProductosDestacadosSeed } from "@/lib/catalogo/seed";

const featuredProducts = getProductosDestacadosSeed(3);
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col px-4 pb-10 pt-4 sm:px-6 lg:px-8">
          ...
          <div className="panel-surface interactive-card relative overflow-hidden rounded-3xl border border-[#587055]/15 p-6 sm:p-7">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-[#587055]/10 bg-white/70 px-4 py-3">
                <p className="text-xs uppercase tracking-[0.2em] text-[#587055]">Selección</p>
                <p className="mt-1 font-brand text-lg text-[#0B3816]">Productos naturales y funcionales</p>
              </div>
              <div className="rounded-2xl border border-[#587055]/10 bg-white/70 px-4 py-3">
                <p className="text-xs uppercase tracking-[0.2em] text-[#587055]">Especialidades</p>
                <p className="mt-1 font-brand text-lg text-[#0B3816]">Sin TACC, keto, integral y más</p>
              </div>
              <div className="rounded-2xl border border-[#587055]/10 bg-white/70 px-4 py-3">
                <p className="text-xs uppercase tracking-[0.2em] text-[#587055]">Compra simple</p>
                <p className="mt-1 font-brand text-lg text-[#0B3816]">Explorá, elegí y pagá online</p>
              </div>
            </div>
          </div>
          ...
          <aside className="panel-surface interactive-card relative overflow-hidden rounded-3xl border border-[#587055]/15 p-6">
            ...
            <div className="mx-auto mb-5 max-w-[18rem]">
              <Image
                ...
                alt="Logo principal CHIA Espacio Saludable"
                width={768}
                height={768}
            ...
            <div className="mt-5 rounded-2xl border border-[#B8858E]/25 bg-[#B8858E]/10 p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-[#0B3816]/80">
                Queremos acercarte productos nobles y prácticos para una alimentación más equilibrada,
                con categorías pensadas para quienes buscan bienestar, energía y opciones de calidad.
              </p>
            </div>
          </aside>
        </section>
        ...
        <section className="scroll-reveal reveal-delay-2 mb-6">
          <div className="mb-3 flex items-end justify-between gap-3">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#587055]">Selección CHIA</p>
            ...
            <div className="hidden items-center gap-2 rounded-full border border-[#8BA37D]/35 bg-white/65 px-3 py-1.5 text-xs text-[#587055] sm:flex">
              ...
              Elegidos para tu rutina saludable
            </div>
          </div>
        ...
        <footer className="panel-surface interactive-card scroll-reveal reveal-delay-4 rounded-3xl border border-[#587055]/15 p-4 sm:p-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              <Image src="/branding/logo-simplificado.png" alt="Símbolo CHIA" width={48} height={48} className="h-10 w-10 rounded-full" />
              <div>
                <p className="font-brand text-lg leading-none text-[#0B3816]">CHIA</p>
                <p className="text-xs uppercase tracking-[0.26em] text-[#587055]">Espacio saludable</p>
              </div>
            </div>
            <div className="text-sm text-[#0B3816]/75">
              Productos seleccionados para acompañar una vida más natural, práctica y consciente.
            </div>
          </div>
        </footer>
      </div>
